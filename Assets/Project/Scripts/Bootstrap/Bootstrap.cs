...
namespace ECS
{
    public sealed class Bootstrap
    {
        ...
        // meshes prefabs
        static public MeshInstanceRenderer playerRenderer ;
        ...
        public static void _InitializeWithScene ()
        {
            ...
            playerRenderer = _GetRendererFromPrefab ( "Prefab01" ) ;            
        ...
        private static MeshInstanceRenderer _GetRendererFromPrefab ( string protoName )
        {
